...
This is related to the notebook in `ml/classify.ipynb`, which includes analysis and quantitative comparisons between [CLIP](https://github.com/openai/CLIP) and [OCR via Tesseract](https://github.com/UB-Mannheim/tesseract) measures.
